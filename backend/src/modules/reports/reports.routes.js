...
router.get("/leaves", authorize("SUPER_ADMIN", "ADMIN", "HR"), getLeaveReport);
router.get("/payroll", authorize("SUPER_ADMIN", "ADMIN", "FINANCE"), getPayrollReport);
router.get("/attrition", authorize("SUPER_ADMIN", "ADMIN", "HR"), getAttritionReport);
router.get("/new-joiners", authorize("SUPER_ADMIN", "ADMIN", "HR"), getNewJoinersReport);
...
router.get("/anomalies", authorize("SUPER_ADMIN", "ADMIN", "HR"), getAnomalyReport);
