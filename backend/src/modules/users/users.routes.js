...
router.post("/", authorize("SUPER_ADMIN", "ADMIN", "HR"), validate(createUserSchema), createUser);
router.put("/:id", authorize("SUPER_ADMIN", "ADMIN", "HR"), validate(updateUserSchema), updateUser);
